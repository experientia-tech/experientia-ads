...
export async function GET(request: NextRequest) {
    try {
        ...
        const memberRole = 'CAMPAIGN_MANAGER';
        ...
        return NextResponse.json(
            {
                ...
                statusCode: 200,
                token: authToken,
                message: "Managed campaigns fetched successfully",
                ...campaigns,
            },
        );
    } catch (error) {
        console.error("Error fetching managed campaigns:", error);
        const errorMessage =
            error instanceof Error ? error.message : "Failed to fetch managed campaigns";
